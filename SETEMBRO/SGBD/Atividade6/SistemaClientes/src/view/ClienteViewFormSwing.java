...
public class ClienteViewFormSwing extends JFrame {
    ...
    private JPanel createButtonPanel() {
        ...
        btnAtualizar.setBackground(azul); btnAtualizar.setForeground(Color.WHITE); btnAtualizar.setFocusPainted(false);
    ...
    /*
     * Atualiza os dados de um cliente selecionado na tabela.
     * Permite edição nos campos e salva após confirmação.
     */
